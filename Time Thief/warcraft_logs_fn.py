...
def get_logs(api_key, guild_info, log_start=0):
    ...
    link = "https://classic.warcraftlogs.com:443/v1/reports/guild/" +  \
...
def save_logs(api_key, guild_info, log_start=0):
    '''
    ...
    for log_id in log_info.log_id:
        ...
        if not os.path.exists(file_path):
            ...
            link = "https://classic.warcraftlogs.com:443/v1/report/fights/" \
                + log_id + "?api_key="
...
def player_info_query(player_name, guild_info, metric, api_key, partition=None,
    ...
    try:
        ...
        link_str = "https://classic.warcraftlogs.com:443/v1/rankings/character/" + \
...
def create_link(api_key,
    ...
    link_start = 'https://classic.warcraftlogs.com:443/v1/report/tables/'
...
def create_link_damage_done(api_key, log_df, log, boss_id=None):
    ...
    link_start = 'https://classic.warcraftlogs.com:443/v1/report/tables/damage-taken/'
    end_info = '?end=' + str(end) + '&'
